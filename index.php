...
$bot->command('ping', function ($message) use ($bot) {
	$bot->sendMessage("AAAAAEB1hZY2FTho6q4amQ", '#Услуги #Продам
...
$bot->on(function($Update) use ($bot){
	...
	if($uname!="nitcshe"){
	if($cid==-1001132568494){
	if($message->getChat()->getUsername() == "PProgProm"){
	$bot->deleteMessage(-1001132568494, $message->getMessageId());	
	$bot->sendMessage("322682583", "$uname : $mtext");		
	$bot->restrictChatMember(-1001132568494, $uid , strtotime("+3660 days"), false, false, false, false);
	}}}
